...
String adjective = JOptionPane.showInputDialog("(adjective)");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more"+ adjective+"during the day, so cross the river at night. Piranhas are attracted to fresh" + liquid+ "and will most likely take a bite out of your"+body+" if you "+verb+". If you have an open wound, whatever you do, try to find another way back to the "+place+". Good Luck!");
